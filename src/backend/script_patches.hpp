...
namespace big
{
	void register_script_patches()
	{
		...
		g_script_patcher_service->add_patch({"freemode"_J, "disable population load balancing", "2D 00 07 00 00 7B", 5, {0x2E, 0x00, 0x00}, nullptr}); // disable population load balancing, YimMenu/discussions/3258
		...
		g_script_patcher_service->add_patch({"freemode"_J, "unhide_players_from_player_list", "2D 01 03 00 00 38 00 71 72 5D ? ? ? 06 56 ? ? 71 2E ? ? 2C ? ? ? 71", 5, {0x72, 0x2E, 0x01, 0x01}, nullptr});
