...
namespace big
{
	...
	{
		if (bad_players_nm::is_blocked(player_info->m_gamer_handle.m_rockstar_id))
		{
			...
			auto is_spammer = bad_players_nm::bad_players_list[player_info->m_gamer_handle.m_rockstar_id].is_spammer;
